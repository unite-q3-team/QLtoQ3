...
_merge(
    "en",
    {
        ...
        "gui.dep_hint_ffmpeg": "ffmpeg: https://ffmpeg.org/download.html#build-windows",
        "gui.dep_hint_steamcmd": "steamcmd: https://steamcdn-a.akamaihd.net/client/installer/steamcmd.zip",
        ...
        "gui.update_install_now": "install update now",
        "gui.update_no_pending": "download update first.",
        ...
        "gui.update_deferred": "update {latest} is ready. it will install after app close.",
...
_merge(
    "ru",
    {
        ...
        "gui.update_install_now": "установить обновление сейчас",
        "gui.update_no_pending": "сначала скачайте обновление.",
        ...
        "gui.update_deferred": "обновление {latest} готово. установка начнется после закрытия приложения.",
